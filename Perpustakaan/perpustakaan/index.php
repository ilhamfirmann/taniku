    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html" >Daftar Pinjaman Buku </a>
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 13px;"><?php echo date('d-M-Y G:i:s'); ?>&nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Keluar</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/20274763.png" class="user-image img-responsive"/>
					</li>
					...
					<?php if($_SESSION['admin']){
                      ...
                      <li>
                        <a  href="?page=buku"><i class="fa fa-table fa-3x"></i> Data Anggota </a>
                    </li>
						<?php
					} ?>
